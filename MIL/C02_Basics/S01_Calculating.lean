...
example (a b : ℝ) : (a + b) * (a - b) = a ^ 2 - b ^ 2 := by
  rw[pow_two, pow_two, sub_eq_add_neg a b, add_mul, mul_add, mul_add, ← add_assoc, mul_neg, mul_neg, mul_comm a b, add_assoc (a * a), add_comm (-(b * a)) (b * a), ← sub_eq_add_neg, ← sub_eq_add_neg, sub_eq_zero_of_eq rfl, add_zero]
